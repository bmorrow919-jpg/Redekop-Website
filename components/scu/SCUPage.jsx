  ...
  const pillars = [
    {
      ...
      icon: "assets/scu/icon-maintenance.png",
      bullets: [
    ...
    },
    {
      ...
      icon: "assets/scu/icon-finances.png",
      bullets: [
    ...
    },
    {
      ...
      icon: "assets/scu/icon-yields.png",
      bullets: [
    ...
    <section className="scu-how" data-screen-label="05 How It Works">
      <div className="wrap">
        ...
        <div className="stage">
          ...
          <video
            src="assets/scu/how-it-works.mp4"
            controls
            preload="metadata"
            playsInline
          />
  ...
  const features = [
    {
      ...
      media: { kind: "video", src: "assets/scu/integrated-design.mp4", fit: "cover" },
    },
    {
      title: "Easy Access",
      ...
      media: { kind: "image", src: "assets/scu/easy-access.gif", fit: "cover", bg: "#000" },
    },
    {
      ...
      media: { kind: "image", src: "assets/scu/mill-design.png", fit: "contain", bg: "var(--ink-50)" },
    },
    {
      ...
      media: { kind: "image", src: "assets/scu/drive-engage.gif", fit: "cover", bg: "#000" },
    },
    {
      ...
      media: { kind: "image", src: "assets/scu/integrated-monitoring.png", fit: "cover" },
    },
    {
      ...
      media: { kind: "image", src: "assets/scu/wheat-sunset.jpg", fit: "cover" },
    },
  ];
      ...
      <div className="wrap">
        <div>
          ...
          <div style={{ marginTop: 36 }}>
            <img
              src="assets/scu/cta-aerial-tracks.jpg"
